...
let weatherData = _weather_api__WEBPACK_IMPORTED_MODULE_0__.fetchForecast("Boston", 7);
...
function createCurrentDisplay(currentWeather) {
  ...
  date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(currentWeather.date, "PPP");
...
function createForecastDay(dayInfo) {
  ...
  date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(dayInfo.date, "EEEE");
  if (displayFahrenheit) {
...
function handleWeatherFetch(forecastJSON) {
  const currentData = _weather_api__WEBPACK_IMPORTED_MODULE_0__.parseCurrentWeather(forecastJSON);
  const forecastData = _weather_api__WEBPACK_IMPORTED_MODULE_0__.parseForecast(forecastJSON);
  const upcoming = document.querySelector(".upcoming>.days");
  ...
  upcoming.replaceChildren(...forecastData.map(dayInfo => createForecastDay(dayInfo)));
}
...
fetchButton.addEventListener("click", () => {
  addLoadingSpinner();
  weatherData = _weather_api__WEBPACK_IMPORTED_MODULE_0__.fetchForecast(getCityValue(), 7);
  weatherData.then(handleWeatherFetch).catch(handleFetchError);
});
...
/* harmony export */   parseCurrentWeather: () => (/* binding */ parseCurrentWeather),
...
async function fetchForecast(city, days) {
  const forecast = await fetch(`${BASE_URL}/forecast.json?key=${API_KEY}&q=${city}&days=${days}&aqi=yes&alerts=yes`);
...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,qBAAqB;EACrB,kBAAkB;EAClB,cAAc;AAChB;;AAEA;EACE,aAAa;EACb,6BAA6B;EAC7B,eAAe;EACf,uBAAuB;EACvB,kBAAkB;EAClB,YAAY;AACd;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;AACzB;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,cAAc;EACd,aAAa;EACb,mBAAmB;EACnB,sBAAsB;AACxB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;AACzB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,WAAW;EACX,gBAAgB;AAClB;;AAEA;EACE,cAAc;EACd,uBAAuB;EACvB,kBAAkB;EAClB,aAAa;EACb,kBAAkB;EAClB,gBAAgB;AAClB;;AAEA;EACE,qBAAqB;EACrB,WAAW;EACX,YAAY;AACd;AACA;EACE,YAAY;EACZ,cAAc;EACd,WAAW;EACX,YAAY;EACZ,WAAW;EACX,kBAAkB;EAClB,sBAAsB;EACtB,+CAA+C;EAC/C,6CAA6C;AAC/C;AACA;EACE;IACE,uBAAuB;EACzB;EACA;IACE,yBAAyB;EAC3B;AACF;;AAEA;EACE,sBAAsB;AACxB;;AAEA;EACE,uBAAuB;AACzB;;AAEA;EACE,kBAAkB;AACpB","sourcesContent":["body {\n  background: lightblue;\n  font-family: arial;\n  color: #00626f;\n}\n\n.forecast-display {\n  display: flex;\n  justify-content: space-around;\n  flex-wrap: wrap;\n  border: 3px white solid;\n  border-radius: 5px;\n  padding: 5px;\n}\n\n.forecast-display > .condition {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n}\n\n.condition > p {\n  text-align: center;\n}\n\n.temperature {\n  font-size: 3em;\n  display: flex;\n  align-items: center;\n  min-width: max-content;\n}\n\n.additional-data {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n}\n\n.days {\n  display: flex;\n  justify-content: start;\n  gap: 0.5rem;\n  overflow: scroll;\n}\n\n.forecast {\n  flex: 1 1 auto;\n  border: 3px white solid;\n  border-radius: 5px;\n  padding: 1rem;\n  text-align: center;\n  min-width: 100px;\n}\n\n.lds-dual-ring {\n  display: inline-block;\n  width: 80px;\n  height: 80px;\n}\n.lds-dual-ring:after {\n  content: \" \";\n  display: block;\n  width: 64px;\n  height: 64px;\n  margin: 8px;\n  border-radius: 50%;\n  border: 6px solid #fff;\n  border-color: #fff transparent #fff transparent;\n  animation: lds-dual-ring 1.2s linear infinite;\n}\n@keyframes lds-dual-ring {\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n}\n\n.start {\n  justify-content: start;\n}\n\n.center {\n  justify-content: center;\n}\n\n.upcoming > h3 {\n  text-align: center;\n}\n"],"sourceRoot":""}]);
// Exports
