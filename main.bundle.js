...
function handleWeatherFetch(forecastJSON) {
  const current = _weather_api__WEBPACK_IMPORTED_MODULE_0__.parseCurrentWeather(forecastJSON);
  const forecast = _weather_api__WEBPACK_IMPORTED_MODULE_0__.parseForecast(forecastJSON);
  const upcoming = document.querySelector(".upcoming>.days");
  updateCurrentDisplay(current);
  upcoming.replaceChildren(...forecast.map(dayInfo => createForecastDay(dayInfo)));
}
...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,qBAAqB;EACrB,kBAAkB;EAClB,cAAc;AAChB;;AAEA;EACE,aAAa;EACb,kCAAkC;EAClC,uBAAuB;EACvB,gBAAgB;EAChB,qBAAqB;EACrB,uBAAuB;EACvB,kBAAkB;EAClB,YAAY;AACd;;AAEA;EACE,kBAAkB;EAClB,eAAe;EACf,aAAa;EACb,sBAAsB;EACtB,uBAAuB;AACzB;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,kBAAkB;EAClB,eAAe;EACf,cAAc;EACd,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;AACzB;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,WAAW;AACb;;AAEA;EACE,cAAc;EACd,uBAAuB;EACvB,kBAAkB;EAClB,aAAa;EACb,kBAAkB;AACpB","sourcesContent":["body {\n  background: lightblue;\n  font-family: arial;\n  color: #00626f;\n}\n\n.forecast-display {\n  display: grid;\n  grid-template-columns: 1fr 1fr 1fr;\n  grid-template-rows: 1fr;\n  column-gap: 50px;\n  justify-items: center;\n  border: 3px white solid;\n  border-radius: 5px;\n  padding: 5px;\n}\n\n.forecast-display > .condition {\n  grid-column: 1 / 2;\n  grid-row: 1 / 3;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n}\n\n.condition > p {\n  text-align: center;\n}\n\n.temperature {\n  grid-column: 2 / 3;\n  grid-row: 1 / 3;\n  font-size: 3em;\n  display: flex;\n  align-items: center;\n}\n\n.additional-data {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n}\n\n.days {\n  display: flex;\n  justify-content: center;\n  gap: 0.5rem;\n}\n\n.forecast {\n  flex: 1 1 auto;\n  border: 3px white solid;\n  border-radius: 5px;\n  padding: 1rem;\n  text-align: center;\n}\n"],"sourceRoot":""}]);
// Exports
